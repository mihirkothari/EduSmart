...
if i == 1
                    if @exam_groups[j-1].exam_type == "MarksAndGrades"
                        data[subject_no][j] = @exam_groups[j-1].total_marks(@student)[0]
                        if j < exam_no-1
                            @marks_total = @marks_total + @exam_groups[j-1].total_marks(@student)[0]
                            @max_total = @max_total + @exam_groups[j-1].total_marks(@student)[1]
                        end
                    elsif @exam_groups[j-1].exam_type == "Marks"
                        data[subject_no][j] = @exam_groups[j-1].total_marks(@student)[0]
                        if j < exam_no-1
